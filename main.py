...
def print_statements():
    ...
    print(
        f"The average number of fouls per game for the 2021/22 season was {average_fouls} fouls")
    # printing median fouls to console
    print(
        f"The median number of fouls per game over the course of the 21/22 season is: {median_fouls:.1f}")
    # printing the mode number of fouls to console
    print(
        f"The mode number of fouls per game over the course of the 21/22 season is: {mode_fouls}")
    # printing the max fouls in a game to console
    print(
        f"The maximum number of fouls in a game over the course of the 21/22 season was: {max_fouls}")
    # printing the minimum fouls in a game to console
    print(
        f"The minimum number of fouls in a game over the course of the 21/22 season was: {min_fouls}")
    # printing the range of fouls in a game to console
    print(
        f"The range of fouls in a game over the course of the 21/22 season was: {range_of_fouls}")
    # printing the interquartile range of fouls in a game to console
    print(
        f"The interquartile range of fouls in a game over the course of the 21/22 season was: {interquartile_range}")
    # printing the standard deviation fouls in a game to console
    print(
        f"The standard deviation of fouls in a game over the course of the 21/22 season was: {standard_dev:.2f}")
    # printing the pearson mode skew of fould in a game to console
    print(
        f"The Pearson Mode Skewness of fouls in a game over the course of the 21/22 season was: {pearson_mode:.2f}")
    # printing the alternative pearson mode skew of fouls in a game to console
    print(
        f"The Alternative Pearson Mode Skewness of fouls in a game over the course of the 21/22 season was: {alternative_pearson:.2f}")
...
if __name__ == "__main__":
    ...
    highest_avg_fouls_per_game = ref_with_highest_average_of_fouls_given_per_game(
    ...
    lowest_avg_fouls_per_game = ref_with_lowest_average_of_fouls_given_per_game(
        average_fouls_per_game_dict)
    # calling the pie_chart_from_data from dictionary_visualisations.py to create a pie chart from average referees data dictionary and place diagram in charts folder
    pie_chart_from_data(average_fouls_per_game_dict)
    # calling the bar_chart_from_data from dictionary_visualisations.py to create a horizontal bar chart from average referees data dictionary and place diagram in charts folder
    bar_chart_from_data(average_fouls_per_game_dict)
    # calling the box_plots_from_dict from dictionary_visualisations.py to create a box plot from average referees data dictionary and place diagram in charts folder
