...
def print_statements():
    ...
    while True:
        ...
        # if user input is h then analyse home fouls data
            ...
            get_mean = input("Get the mean? y/n?")
            ...
            get_median = input("Get the median? y/n?")
            ...
            get_mode = input("Get the mode? y/n?")
            ...
            get_max = input("Get the max value? y/n?")
            ...
            get_min = input("Get the minimum value? y/n?")
            ...
            get_range = input("Get the range? y/n?")
            ...
            get_iqr = input("Get the interquartile range? y/n?")
            ...
            get_standard_dev = input("Get the standard deviation? y/n?")
            ...
            get_mode_skew = input("Get the mode skew? y/n?")
            ...
            get_median_skew = input("Get the median skew? y/n?")
        ...
        get_sub_categories = input("Get the total sub categories "
                                   " based on referees dictionary? y/n?")
        # if input is y then get cdistinct sub categories
        if get_sub_categories.lower().startswith("y"):
            # gets the unique number of referrees sub categories and returns
            # for use in print statement from
            # dictionary_calculations.py using function distinct_sub_categories
        ...
        # asks the users for input to get the ref who gave the highest average
        # fouls
        get_highest_avg = input("Get the referee who "
                                " gave the highest average of fouls? y/n?")
        # if input is y then get the ref qho gave the highest average
        # fouls
        if get_highest_avg.lower().startswith("y"):
            # gets the referee with highest average of fouls given and returns
            # for use in print statement from dictionary_calculations.py using
        ...
        # asks the users for input to get the ref who gave the lowest average
        # fouls
        get_lowest_avg = input("Get the referee who "
                               " gave the lowest average of fouls? y/n?")
        ...
        if get_lowest_avg.lower().startswith("y"):
            ...
            # returns for use in print statement from dictionary_calculations
        ...
        get_pie_chart = input("Get a pie chart "
                              " showing total fouls given by each ref? y/n?")
        # if input is y then get the pie chart
        if get_pie_chart.lower().startswith("y"):
            # calling the pie_chart_from_data from dictionary_visualisations.py
            # to create a pie chart from total referees data dictionary and
            # place diagram in charts folder
        ...
        get_bar_chart = input("Get a bar chart "
                              " showing average fouls given by each ref? y/n?")
        # if input is y then get the bar chart
        if get_bar_chart.lower().startswith("y"):
            # calling the bar_chart_from_data from dictionary_visualisations.py
            # to create a horizontal bar chart from average referees data
        ...
        get_box_plot_from_dict = input("Get a box plot showing average fouls"
                                       " given by each ref? y/n?")
        # if input is y then get the box plot chart
        if get_box_plot_from_dict.lower().startswith("y"):
            # calling the box_plots_from_dict from dictionary_visualisations.py
            # to create a box plot from average referees data dictionary and
            # place diagram in charts folder
